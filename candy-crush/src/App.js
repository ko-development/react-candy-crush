...
const width = 8;
const candyColours = [blueCandy, greenCandy, orangeCandy, purpleCandy, redCandy, yellowCandy]
...
const App = () => {
  ...
  //Move candies down & generate new candies
  ...
  //Get squares being dragged/replaced
  const dragStart = (e) => {
  ...
  }, [checkForColumnOfFour,checkForColumnOfThree,checkForRowOfThree,checkForRowOfFour, moveIntoSquareBelow, currentColourArrangement])
